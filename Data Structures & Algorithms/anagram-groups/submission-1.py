class Solution:
    # note: a better solution wouldn't use indexes, it would just create a
    # list of strings and then combine the lists at the end without needing
    # to change from a list of indexes to their connected strings
